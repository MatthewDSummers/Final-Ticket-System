    ...
    ***************************************************************************** */
    ...
    function makeCalendar(element){
        flatpickr(element, {
            ...
            "plugins": [new rangePlugin({ input: "#form-date-second-input"})]
        });
    }
    

$(document).ready(function(){
    var calendar_elements = document.querySelectorAll(".calendar-element")
    for (const element of calendar_elements){
        console.log(element)
